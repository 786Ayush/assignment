...
export default function Home() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen px-4 sm:px-8 relative bg-black">
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <span className="text-xl sm:text-3xl font-semibold text-white">FirstStore</span>
      </div>
    </div>
  );
}
